/* GENERATED by schwung-canvaskit v2 — DO NOT EDIT THIS FILE.
...
/* The active bank's cells for the current sub-page. */
function cellsFor(ctx, bank, sub) {
  if (bank.steps && sub >= 1) return stepCells(bank, sub - 1);
  return bank.dynamicCells ? bank.dynamicCells(ctx) : bank.knobs;
}
...
const bank_editor = {
  ...
  onMidi(ctx, payload) {
    ...
    const cell = cellsFor(ctx, bank, s.sub || 0)[k];
  ...
  draw(ctx) {
    ...
    else drawBankView(ctx, bank, cellsFor(ctx, bank, 0), s);
  ...
  _test: Object.assign({
    ...
    cellsFor, subPageCount, stepCells, stepVals, shapeSample, hudCard
  }, CONFIG.testExports || {})
};
